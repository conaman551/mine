...
CREATE SEQUENCE "USER_UID_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1;
...
ALTER TABLE ONLY "public"."ACTIVE_FILTERS" ADD CONSTRAINT "ACTIVE_FILTERS_UID_fkey" FOREIGN KEY ("UID") REFERENCES "USER"("UID") ON UPDATE CASCADE ON DELETE CASCADE NOT DEFERRABLE;
...
ALTER TABLE ONLY "public"."ACTIVE_TAGS" ADD CONSTRAINT "ACTIVE_TAGS_UID_fkey" FOREIGN KEY ("UID") REFERENCES "USER"("UID") ON UPDATE CASCADE ON DELETE CASCADE NOT DEFERRABLE;

ALTER TABLE ONLY "public"."BLOCKS" ADD CONSTRAINT "BLOCKS_UID1_fkey" FOREIGN KEY ("UID1") REFERENCES "USER"("UID") ON UPDATE CASCADE ON DELETE CASCADE NOT DEFERRABLE;
ALTER TABLE ONLY "public"."BLOCKS" ADD CONSTRAINT "BLOCKS_UID2_fkey" FOREIGN KEY ("UID2") REFERENCES "USER"("UID") ON UPDATE CASCADE ON DELETE CASCADE NOT DEFERRABLE;

ALTER TABLE ONLY "public"."CHAT" ADD CONSTRAINT "CHAT_UID1_fkey" FOREIGN KEY ("UID1") REFERENCES "USER"("UID") ON UPDATE CASCADE ON DELETE CASCADE NOT DEFERRABLE;
ALTER TABLE ONLY "public"."CHAT" ADD CONSTRAINT "CHAT_UID2_fkey" FOREIGN KEY ("UID2") REFERENCES "USER"("UID") ON UPDATE CASCADE ON DELETE CASCADE NOT DEFERRABLE;

ALTER TABLE ONLY "public"."LIKES" ADD CONSTRAINT "LIKES_UID1_fkey" FOREIGN KEY ("UID1") REFERENCES "USER"("UID") ON UPDATE CASCADE ON DELETE CASCADE NOT DEFERRABLE;
ALTER TABLE ONLY "public"."LIKES" ADD CONSTRAINT "LIKES_UID2_fkey" FOREIGN KEY ("UID2") REFERENCES "USER"("UID") ON UPDATE CASCADE ON DELETE CASCADE NOT DEFERRABLE;

ALTER TABLE ONLY "public"."MATCHED" ADD CONSTRAINT "MATCHED_UID1_fkey" FOREIGN KEY ("UID1") REFERENCES "USER"("UID") ON UPDATE CASCADE ON DELETE CASCADE NOT DEFERRABLE;
ALTER TABLE ONLY "public"."MATCHED" ADD CONSTRAINT "MATCHED_UID2_fkey" FOREIGN KEY ("UID2") REFERENCES "USER"("UID") ON UPDATE CASCADE ON DELETE CASCADE NOT DEFERRABLE;

ALTER TABLE ONLY "public"."MAYBE" ADD CONSTRAINT "MAYBE_UID1_fkey" FOREIGN KEY ("UID1") REFERENCES "USER"("UID") ON UPDATE CASCADE ON DELETE CASCADE NOT DEFERRABLE;
ALTER TABLE ONLY "public"."MAYBE" ADD CONSTRAINT "MAYBE_UID2_fkey" FOREIGN KEY ("UID2") REFERENCES "USER"("UID") ON UPDATE CASCADE ON DELETE CASCADE NOT DEFERRABLE;
...
ALTER TABLE ONLY "public"."MESSAGES" ADD CONSTRAINT "MESSAGES_Sender_id_fkey" FOREIGN KEY ("Sender_id") REFERENCES "USER"("UID") ON UPDATE CASCADE ON DELETE CASCADE NOT DEFERRABLE;

ALTER TABLE ONLY "public"."REJECTS" ADD CONSTRAINT "REJECTS_UID1_fkey" FOREIGN KEY ("UID1") REFERENCES "USER"("UID") ON UPDATE CASCADE ON DELETE CASCADE NOT DEFERRABLE;
ALTER TABLE ONLY "public"."REJECTS" ADD CONSTRAINT "REJECTS_UID2_fkey" FOREIGN KEY ("UID2") REFERENCES "USER"("UID") ON UPDATE CASCADE ON DELETE CASCADE NOT DEFERRABLE;

ALTER TABLE ONLY "public"."REPORTS" ADD CONSTRAINT "REPORTS_UID1_fkey" FOREIGN KEY ("UID1") REFERENCES "USER"("UID") ON UPDATE CASCADE ON DELETE CASCADE NOT DEFERRABLE;
ALTER TABLE ONLY "public"."REPORTS" ADD CONSTRAINT "REPORTS_UID2_fkey" FOREIGN KEY ("UID2") REFERENCES "USER"("UID") ON UPDATE CASCADE ON DELETE CASCADE NOT DEFERRABLE;
