...
function Numberverify( {route} ) {
    ...
    const handleSubmit = async () => {
        if (isCodeComplete) {
            ...
            const payload = {
                uid : userId,
                code : verificationCode //change this 
            }
        ...
        <TouchableWithoutFeedback onPress={handleFocus}>
            <View style={styles.container}>
                <TouchableOpacity
                    ...
                    onPress={() => navigation.navigate('Number', {userId : userId})} 
                >
                ...
                <Text style={styles.instructionText}>Enter the code from the SMS{'\n'}we sent you</Text>
